                        ...
                        @if(!empty($getNetProfitStatistics))
                            <div class="statistic-details mt-4 position-relative">
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value">{{ addCurrencyToPrice($getNetProfitStatistics['todayIncome']['amount']) }}</div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value">{{ addCurrencyToPrice($getNetProfitStatistics['weekIncome']['amount']) }}</div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value">{{ addCurrencyToPrice($getNetProfitStatistics['monthIncome']['amount']) }}</div>
                                ...
                                <div class="statistic-details-item">
                                    ...
                                    <div class="detail-value">{{ addCurrencyToPrice($getNetProfitStatistics['yearIncome']['amount']) }}</div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingClasses as $getTopSellingClass)
                                    <tr>
                                        ...
                                        <td>{{ addCurrencyToPrice($getTopSellingClass->sales_amount) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingAppointments as $getTopSellingAppointment)
                                    <tr>
                                        ...
                                        <td>{{ addCurrencyToPrice($getTopSellingAppointment->sales_amount) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingTeachers as $getTopSellingTeacher)
                                    <tr>
                                        ...
                                        <td>{{ addCurrencyToPrice($getTopSellingTeacher->sales_amount) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getTopSellingOrganizations as $getTopSellingOrganization)
                                    <tr>
                                        ...
                                        <td>{{ addCurrencyToPrice($getTopSellingOrganization->sales_amount) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
                            ...
                            <table class="table table-striped font-14">
                                ...
                                @foreach($getMostActiveStudents as $getMostActiveStudent)
                                    <tr>
                                        ...
                                        <td>{{ addCurrencyToPrice($getMostActiveStudent->total_cost) }}</td>
                                    </tr>
                                @endforeach
                            </table>
                        </div>
