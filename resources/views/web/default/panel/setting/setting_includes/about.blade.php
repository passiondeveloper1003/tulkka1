<section>
    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-6">
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('panel.goals') }}</label>
                <textarea name="goals" rows="3" class="form-control @error('bio') is-invalid @enderror">{{ $user->goalsStr() }}</textarea>
                @error('goals')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mt-15">
                    <p class="font-12 text-gray">- {{ trans('panel.comma_separated') }}</p>
                </div>
