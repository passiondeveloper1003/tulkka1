        ...
        @if ($user->isTeacher())
            <div class="col-12 col-lg-4">
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('auth.video_demo') }}</label>

                    <img src="{{ !empty($user) && $user->video_demo ? '/store/' . $user->video_demo_thumb : '' }}"
                        alt="" id="profileImagePreview" width="250" class="rounded my-15 d-block ml-5">


                    <button id="selectVideoButton" type="button" class="btn btn-sm btn-secondary"
                        data-ref-video="profileImagePreview" data-ref-input="video_demo">
                        <i data-feather="arrow-up" width="18" height="18" class="text-white mr-10"></i>
                        {{ trans('auth.select_video') }}
                    </button>
                    <label class="input-label mt-2">{{ trans('auth.mp4_format') }}</label>

                    <div class="input-group">
                        <input type="file" style="display: none" name="video_demo" id="video_demo" accept="video/*"
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <button type="button" class="input-group-text panel-file-manager" data-input="cover_img"
                                data-preview="holder">
